 ...
 */
const beep = new Audio("https://scheibig.github.io/KCK-Kuchenka/src/resources/Button Beep Sound Effect.mp3")

/**
 * Dźwięk dzwonka (a'la minutnik kuchenny) używany przy zakończeniu pieczenia.
 */
const ring = new Audio("https://scheibig.github.io/KCK-Kuchenka/src/resources/toaster oven ding  sound effect.mp3")
